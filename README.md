...
**ATTENTION! This is a custom fork of the original project at [https://github.com/acmesh-official/acme.sh/](https://github.com/acmesh-official/acme.sh/).** \
Included changes are listed in the file [CHANGELOG_maddes-b.adoc](CHANGELOG_maddes-b.adoc).
